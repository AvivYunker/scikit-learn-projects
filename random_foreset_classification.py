...
from sklearn.ensemble import RandomForestClassifier  # The machine learning model we will be using
...
model = RandomForestClassifier(n_estimators=100)  # Initialize the model. The parameter n_estimators is the number of trees in the forest
