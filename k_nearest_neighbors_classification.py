...
from sklearn.neighbors import KNeighborsClassifier  # The machine learning model we will be using
...
model = KNeighborsClassifier(n_neighbors=3)  # Initialize the model. The parameter n_neighbors is the 'k' in 'k-nearest neighbors'
